    ...
    <div>
      ...
      <main className="container mx-auto max-w-4xl px-5 py-16">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            Das nachfolgend dargestellte Widerrufsrecht gilt ausschließlich für{" "}
            <strong>Verbraucher</strong> im Sinne des § 13 BGB. Verbraucher ist
          ...
          <p className="mb-4">
            <strong>Beispiele:</strong> Privatpersonen, die ein Gutachten für
            ihre private Photovoltaikanlage beauftragen, oder Hauseigentümer,
            die eine Beratung zu ihrem Batteriespeicher wünschen.
          </p>
          <p className="mb-4">
            <strong>Kein Widerrufsrecht</strong> haben Unternehmen,
            Gewerbetreibende und Freiberufler (§ 14 BGB), z. B.
            PV-Installationsbetriebe, Projektentwickler oder Energieversorger.
          </p>
          <p className="mb-4">
            Das Widerrufsrecht besteht bei Verträgen, die im{" "}
            <strong>Fernabsatz</strong> (per E-Mail, Telefon, Website,
            Messenger) oder <strong>außerhalb von Geschäftsräumen</strong> (z.
            B. beim Vor-Ort-Termin bei Ihnen zu Hause) geschlossen werden (§§
            312b, 312c, 312g BGB). Kein Widerrufsrecht besteht bei Verträgen,
            die in unseren Geschäftsräumen geschlossen werden.
          </p>
          <p className="mb-4">
            <strong>Hinweis:</strong> Das Fernabsatzrecht verwendet den Begriff
            „Dienstleistung" im Sinne des europäischen Verbraucherrechts. Dieser
            umfasst alle unsere Sachverständigenleistungen, einschließlich der
            Gutachtenerstellung (die nach deutschem Recht als Werkvertrag gemäß
            § 631 BGB eingeordnet wird) und der Beratungsleistungen
        ...
        <section className="mb-10">
          ...
          <p className="mb-4 text-gray-600 text-sm">
            ...
            entspricht dem gesetzlichen Muster gemäß Anlage 1 zu Art. 246a § 1
            Abs. 2 EGBGB und wird Ihnen bei Vertragsschluss zusätzlich auf einem
            dauerhaften Datenträger (E-Mail mit PDF-Anhang) übermittelt.
          </p>
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            Wenn Sie möchten, dass wir vor Ablauf der 14-tägigen Widerrufsfrist
            mit der Leistung beginnen, benötigen wir von Ihnen:
          </p>
          <ol className="mb-4 list-inside list-decimal space-y-2 pl-4">
            <li>
              Ihre <strong>ausdrückliche Zustimmung</strong>, dass wir vor
              Ablauf der Widerrufsfrist mit der Leistungserbringung beginnen,
              und
            </li>
            <li>
              Ihre <strong>Bestätigung</strong>, dass Sie Kenntnis davon haben,
              dass Sie bei vollständiger Vertragserfüllung Ihr Widerrufsrecht
              verlieren.
            </li>
          </ol>
          <p className="mb-6">
            Ohne Ihre Einwilligung beginnen wir grundsätzlich erst nach Ablauf
            der 14-tägigen Widerrufsfrist mit der Leistungserbringung.
          </p>
          ...
          <p className="mb-4">
            ...
            Verlangen bereits mit der Leistung begonnen haben, schulden Sie uns
            einen angemessenen Betrag für die bis zum Widerruf erbrachten
            Teilleistungen:
          </p>
          <ul className="mb-4 list-disc space-y-2 pl-6">
            <li>
              <strong>Bei Pauschalhonorar:</strong> Der Wertersatz entspricht
              dem Anteil der bereits erbrachten Leistung am Gesamtumfang,
              bezogen auf den vereinbarten Pauschalpreis.
            </li>
            <li>
              <strong>Bei Zeithonorar:</strong> Der Wertersatz entspricht den
              tatsächlich geleisteten Stunden zum vereinbarten Stundensatz gemäß
              Auftragsbestätigung.
            </li>
          </ul>
          <p className="mb-6">
            <strong>Wichtig:</strong> Wurden Sie nicht ordnungsgemäß über das
            Widerrufsrecht belehrt oder haben Sie nicht ausdrücklich verlangt,
            dass wir vor Ablauf der Widerrufsfrist mit der Leistung beginnen,
            schulden Sie keinen Wertersatz (§ 357a Abs. 2 Satz 2 BGB).
          </p>
          ...
          <p className="mb-4">
            ...
            vollständig erbracht haben und Sie zuvor ausdrücklich zugestimmt
            haben, dass wir vor Ablauf der Widerrufsfrist mit der
            Leistungserbringung beginnen, und Ihre Kenntnis davon bestätigt
            haben, dass Sie mit vollständiger Vertragserfüllung Ihr
        ...
        <section className="mb-10">
          ...
          <p className="mb-4 text-gray-600 text-sm">
            Gemäß Anlage 2 zu Art. 246a § 1 Abs. 2 EGBGB. Die Verwendung dieses
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
            ...
            <p className="mb-2">Name des/der Verbraucher(s): _______________</p>
            <p className="mb-2">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            ...
            , insbesondere § 10 AGB (Widerrufsrecht für Verbraucher), § 2.1 AGB
            (Unterscheidung Werk- und Dienstverträge) und § 6 AGB (Vergütung und
            Abrechnung). Bei Widersprüchen gehen die gesetzlichen Regelungen zum
            Widerrufsrecht vor.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p>
            Diese Widerrufsbelehrung basiert auf den §§ 312, 312b, 312c, 312g,
            355, 356, 357, 357a BGB sowie Art. 246a EGBGB einschließlich der
            Anlagen 1 und 2. Die Belehrung in Abschnitt 2 entspricht dem
            gesetzlichen Muster gemäß Anlage 1 zu Art. 246a § 1 Abs. 2 EGBGB.
            Das Muster-Widerrufsformular in Abschnitt 4 entspricht Anlage 2 zu
