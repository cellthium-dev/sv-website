      ...
      <main className="container mx-auto max-w-4xl px-5 py-16">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            ...
            für alle Verträge zwischen Andreas Bauten, zertifizierter
          ...
          <p className="mb-2">Unsere Dienstleistungen umfassen insbesondere:</p>
          ...
          <p className="mb-4">
            Diese AGB gelten ausschließlich. Abweichende, entgegenstehende oder
            ergänzende AGB des Auftraggebers werden nur dann
            Vertragsbestandteil, wenn wir ihrer Geltung ausdrücklich in Textform
            (§ 126b BGB) zugestimmt haben.
          </p>
          ...
          <p className="mb-4">
            Diese AGB gelten sowohl für Verträge mit Verbrauchern (§ 13 BGB) als
            auch mit Unternehmern (§ 14 BGB). Soweit einzelne Regelungen nur für
            eine der beiden Gruppen gelten, wird dies explizit gekennzeichnet.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="mb-3">
            Geschuldet ist die Erstellung des Werkes (Gutachten, Prüfbericht,
            Stellungnahme) nach den anerkannten Regeln der Technik und unter
            Beachtung der ISO/IEC 17024-Standards. Die Vergütung erfolgt als
            Pauschalhonorar oder Zeithonorar. Es gelten die werkvertraglichen
            Gewährleistungsrechte (§ 9.1).
          </p>

          <h4 className="mb-1 font-medium">
            (b) Beratung und technischer Support (Dienstvertrag nach §§ 611–630
            BGB)
          </h4>
          <p className="mb-4">
            Geschuldet ist die qualifizierte Beratung bzw. Unterstützung, nicht
            jedoch ein bestimmter wirtschaftlicher oder technischer Erfolg. Die
            Vergütung erfolgt in der Regel nach Zeithonorar. Eine Erfolgshaftung
            besteht nicht.
          </p>
          ...
          <p className="mb-4">
            ...
            unabhängig und weisungsfrei entsprechend seiner Zertifizierung nach
            ISO/IEC 17024. Er ist berechtigt, Aufträge abzulehnen, die seine
          ...
          <p className="mb-4">
            ...
            Vereinbarung. Mündliche Nebenabreden bedürfen zu ihrer Wirksamkeit
        ...
        <section className="mb-10">
          ...
          <p className="mb-2">
            ...
            nicht ausdrücklich als verbindlich gekennzeichnet sind. Ein Vertrag
          ...
          <p className="mb-2">
            Über auf unserer Website eingebundene Online-Buchungssysteme (z.B.
            Cal.eu) können ausschließlich Terminanfragen gestellt werden; ein
            Vertragsschluss über eine Sachverständigenleistung ist über diese
          ...
          <p className="mb-4">
            Nachträgliche Änderungen oder Erweiterungen des Auftrags bedürfen
            der Textform (§ 126b BGB; z.B. E-Mail). Bei wesentlichen
            Auftragsänderungen, die einen Mehraufwand von voraussichtlich mehr
            als 20 % der ursprünglichen Kostenschätzung verursachen, erstellen
            wir vorab eine neue Kostenschätzung. Ohne Zustimmung des
            Auftraggebers erfolgen keine kostenpflichtigen Zusatzleistungen.
          </p>

          <h3 className="mb-2 font-semibold">3.4 Vollmacht</h3>
          <p className="mb-4">
            Bei Aufträgen durch Unternehmen versichert der Auftraggeber, zur
            Auftragserteilung berechtigt zu sein. Bei fehlender Vertretungsmacht
            haftet die handelnde Person persönlich gemäß § 179 BGB.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>Anlagendokumentation (Pläne, Schaltbilder, Datenblätter)</li>
            <li>Frühere Gutachten, Prüfberichte oder Mängelanzeigen</li>
            <li>Informationen zu Anlagenhistorie und bekannten Problemen</li>
          ...
          <ul className="mb-4 list-disc space-y-1 pl-6">
            ...
            <li>
              Können wir Mehraufwendungen nach dem Zeithonorar gem. § 6.2 Abs. b
              gesondert berechnen.
            </li>
            <li>
              Sind wir berechtigt, die Leistung zu verweigern oder den Vertrag
              außerordentlich zu kündigen (§ 13.2).
            </li>
          </ul>
        ...
        <section className="mb-10">
          ...
          <p className="mb-3">
            Terminverschiebungen durch den Auftraggeber sind bis spätestens 48
            Stunden vor dem vereinbarten Termin kostenfrei möglich. Bei
          ...
          <p className="mb-4">
            ...
            Ausfallpauschale ist. Zusätzlich werden bereits angefallene oder
            nicht mehr stornierbare Reisekosten nach § 6.4 in Rechnung gestellt.
          </p>
          ...
          <p className="mb-4">
            ...
            Einflussbereichs liegende Umstände verlängern vereinbarte Fristen
            angemessen. Dauert der Zustand länger als sechs Wochen an, sind
            beide Parteien berechtigt, den Vertrag in Textform zu kündigen.
          </p>

          <h3 className="mb-2 font-semibold">5.4 Leistungsverzug</h3>
          <p className="mb-4">
            Geraten wir mit der Leistungserbringung in Verzug, kann der
            Auftraggeber uns eine angemessene Nachfrist von mindestens 14 Tagen
            setzen. Erst nach erfolglosem Ablauf dieser Frist können weitere
        ...
        <section className="mb-10">
          ...
          <h3 className="mb-2 font-semibold">6.1 Honorar und Preisgrundlage</h3>
          <p className="mb-4">
            Die Vergütung richtet sich nach der individuellen
            Auftragsvereinbarung. Alle Preise verstehen sich in Euro zzgl. der
            gesetzlichen Umsatzsteuer (derzeit 19 %), sofern diese anfällt. Die
            konkrete Vergütungshöhe wird vor Vertragsschluss transparent
            mitgeteilt.
          </p>

          <h3 className="mb-2 font-semibold">6.2 Vergütungsformen</h3>
          <h4 className="mb-1 font-medium">(a) Pauschalhonorar (Festpreis)</h4>
          <p className="mb-3">
            Für klar definierte Standard-Leistungen bieten wir Pauschalpreise
            an, die den gesamten Leistungsumfang abdecken (Arbeitszeiten,
            Dokumentation, Standardausstattung). Reisekosten werden, soweit
            nicht ausdrücklich inkludiert, gesondert nach § 6.4 abgerechnet.
          </p>
          <h4 className="mb-1 font-medium">(b) Zeithonorar (Stundensatz)</h4>
          <p className="mb-1">
          ...
          <p className="mb-4">
            Bei bestimmten Aufträgen kann eine Kombination aus Grundhonorar und
            Zeithonorar vereinbart werden.
          </p>
          ...
          <p className="mb-2">
            Soweit Reisekosten nicht im Pauschalhonorar inkludiert sind, werden
            sie gesondert abgerechnet:
          </p>
          <ul className="mb-4 list-disc space-y-2 pl-6">
            <li>
            ...
            <li>
              <strong>Reisezeit:</strong> 95,00 EUR/Std. (netto), 6-Minuten-Takt
            </li>
            <li>
              <strong>Übernachtung:</strong> Pauschale 140,00 EUR/Nacht inkl.
              Frühstück
            </li>
            <li>
          ...
          <p className="mb-4">
            ...
            außergewöhnliche Auslagen gesondert berechnet (spezielle Messgeräte,
            externe Fremdleistungen, Normen über 100 EUR, projektspezifische
            Software) – ausschließlich nach vorheriger Abstimmung und Freigabe
            in Textform.
          </p>
          ...
          <ul className="mb-4 list-disc space-y-1 pl-6">
            ...
            <li>
              Standard-Betriebskosten (Telefon, Internet, Strom, Heizung, Miete)
            </li>
            <li>
            ...
            <li>
              Standarddokumentation (bis 50 Seiten S/W, 1 Exemplar + 1 PDF, bis
              10 Fotos)
            </li>
            <li>Versicherungen (Berufshaftpflicht, Rechtsschutz, Kfz)</li>
            <li>Fortbildungskosten und Zertifizierungsgebühren</li>
            <li>Normenzugang (Beuth-Flatrate, VDE-Vorschriftenwerk Basis)</li>
          </ul>
          ...
          <p className="mb-4">
            Bei Zeithonorar-Aufträgen geben wir auf Wunsch eine unverbindliche
            Kostenschätzung ab. Zeichnet sich ab, dass die geschätzte
            Arbeitszeit um mehr als 20 % überschritten wird, informieren wir den
            Auftraggeber unverzüglich und holen eine Freigabe für die
            Fortführung ein.
          </p>

          <h3 className="mb-2 font-semibold">6.8 Abschlagszahlungen</h3>
          <p className="mb-4">
            Bei Aufträgen über 2.500 EUR (netto) oder mit einer Vertragsdauer
            von mehr als einem Monat sind wir berechtigt, Abschlagszahlungen
          ...
          <p className="mb-2">
            ...
            Für Verbraucher beträgt die Zahlungsfrist 30 Tage ab
            Rechnungszugang.
          </p>
          <p className="mb-2">Zahlung ausschließlich per Banküberweisung.</p>
          <p className="mb-4">
            Bei Zahlungsverzug: Verzugszinsen von 9 Prozentpunkten über dem
            Basiszinssatz (Unternehmer) bzw. 5 Prozentpunkten (Verbraucher) über
          ...
          <p className="mb-4">
            ...
            unbestrittenen oder rechtskräftig festgestellten Gegenansprüchen aus
            demselben Vertragsverhältnis. Aufrechnung nur mit unbestrittenen
          ...
          <p className="mb-4">
            Bei Verträgen mit einer Laufzeit von mehr als 12 Monaten behalten
            wir uns vor, die Vergütung jährlich an den Verbraucherpreisindex des
            Statistischen Bundesamtes anzupassen (max. 10 % p.a.). Anpassungen
            werden mindestens 6 Wochen vor Inkrafttreten mitgeteilt. Bei einer
            Erhöhung von mehr als 5 % besteht ein Sonderkündigungsrecht.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            Gutachten und Berichte werden nach bestem Wissen und Gewissen unter
            Beachtung der anerkannten Regeln der Technik und der ISO/IEC
            17024-Standards erstellt. Sie basieren auf den zum Zeitpunkt der
            Erstellung verfügbaren Informationen.
          </p>
          ...
          <ul className="mb-4 list-disc space-y-1 pl-6">
            <li>
              Den vom Auftraggeber bereitgestellten Informationen und Unterlagen
            </li>
            <li>
              Stichprobenartigen und zerstörungsfreien Prüfungen (sofern nicht
              anders vereinbart)
            </li>
            <li>Den bei der Vor-Ort-Besichtigung getroffenen Feststellungen</li>
            <li>
              Den zum Zeitpunkt der Erstellung verfügbaren technischen Normen
            </li>
          </ul>
          ...
          <p className="mb-4">
            ...
            Arbeitsergebnisse sind urheberrechtlich geschützt. Das Urheberrecht
            verbleibt beim Sachverständigen.
          </p>

          <h3 className="mb-2 font-semibold">7.4 Nutzungsrechte</h3>
          <p className="mb-4">
            Der Auftraggeber erhält mit vollständiger Zahlung der Vergütung das
            einfache, nicht übertragbare Recht zur Nutzung der Arbeitsergebnisse
            für den vertraglich vorausgesetzten Zweck.
          </p>

          <h3 className="mb-2 font-semibold">7.5 Verwendungsbeschränkungen</h3>
          <p className="mb-4">
            Eine Veröffentlichung, Vervielfältigung oder Weitergabe an Dritte
            (ausgenommen Behörden, Gerichte, Versicherungen oder
            Kreditinstitute, sofern dies dem vertraglich vorausgesetzten Zweck
            entspricht) sowie eine inhaltliche Bearbeitung oder Änderung bedarf
            unserer vorherigen Zustimmung in Textform.
          </p>

          <h3 className="mb-2 font-semibold">7.6 Gültigkeit und Aktualität</h3>
          <p className="mb-4">
        ...
        <section className="mb-10">
          ...
          <p className="mb-2">
            <strong>Unbeschränkte Haftung:</strong> Wir haften unbeschränkt für
          ...
          <p className="mb-2">
            ...
            Verletzung wesentlicher Vertragspflichten (Kardinalpflichten) ist
            unsere Haftung auf den vertragstypischen, vorhersehbaren Schaden
            begrenzt.
          </p>
          <p className="mb-4">
            <strong>Haftungsausschluss:</strong> Im Übrigen ist die Haftung für
            leichte Fahrlässigkeit ausgeschlossen.
          </p>

          <h3 className="mb-2 font-semibold">8.3 Haftungshöchstbetrag</h3>
          <p className="mb-4">
            Die Haftung für Vermögensschäden bei leicht fahrlässiger Verletzung
            wesentlicher Vertragspflichten ist begrenzt auf das Dreifache des
            Auftragswerts, mindestens jedoch 10.000 EUR, maximal 50.000 EUR je
            Schadensfall.
          </p>
          ...
          <p className="mb-4">
            Wir unterhalten eine Berufshaftpflichtversicherung mit angemessenen
            Deckungssummen. Details können auf Anfrage mitgeteilt werden.
          </p>
          ...
          <p className="mb-4">
            ...
            beruhen, sofern wir diese nicht grob fahrlässig ungeprüft übernommen
            haben.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <h3 className="mb-2 font-semibold">9.1 Verschwiegenheitspflicht</h3>
          <p className="mb-4">
            Wir verpflichten uns zur Einhaltung der beruflichen Verschwiegenheit
            gemäß ISO/IEC 17024. Alle erlangten Informationen werden vertraulich
            behandelt und nicht an Dritte weitergegeben, sofern keine
            gesetzliche Offenbarungspflicht besteht oder der Auftraggeber in
            Textform eingewilligt hat.
          </p>

          <h3 className="mb-2 font-semibold">9.2 Datenschutz</h3>
          <p className="mb-4">
            Die Verarbeitung personenbezogener Daten erfolgt ausschließlich nach
            Maßgabe der DSGVO und des BDSG. Die vollständigen Informationen
          ...
          <p className="mb-4">
            ...
            auftragsbezogener Daten an diese Dritten erfolgen (beschränkt auf
            das Erforderliche).
          </p>
          ...
          <p className="mb-4">
            ...
            betroffen sein können, obliegt es dem Auftraggeber, die betroffenen
            Personen vorab zu informieren.
          </p>
          ...
          <p className="mb-4">
            Der Auftraggeber verpflichtet sich, unsere Arbeitsmethoden, interne
            Prozesse, Kalkulationsgrundlagen und Geschäftsgeheimnisse im Sinne
            des GeschGehG vertraulich zu behandeln. Diese Pflicht besteht auch
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            Verbrauchern steht bei Fernabsatzverträgen (z.B. per E-Mail, Telefon
            oder über die Website) ein gesetzliches Widerrufsrecht gemäß §§
            312g, 355 BGB zu.
          </p>
          ...
          <p className="mb-4">
            Die detaillierte Widerrufsbelehrung und das Muster-Widerrufsformular
            finden Sie unter{" "}
          ...
          <p className="mb-4">
            ...
            wenn Sie als Verbraucher ausdrücklich zugestimmt haben, dass wir vor
            Ablauf der Widerrufsfrist mit der Leistungserbringung beginnen, und
            Sie Ihre Kenntnis davon bestätigt haben (§ 356 Abs. 4 BGB).
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            ...
            Forderungen aus dem jeweiligen Vertragsverhältnis unser Eigentum.
          </p>

          <h3 className="mb-2 font-semibold">11.2 Zurückbehaltungsrecht</h3>
          <p className="mb-4">
            Bis zur vollständigen Bezahlung aller fälligen Forderungen sind wir
            berechtigt, die Herausgabe von Gutachten, Berichten und Unterlagen
            zu verweigern (§ 273 BGB). Dies gilt insbesondere bei Zahlungsverzug
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            ...
            Erfüllung der vereinbarten Leistungen, sofern nicht eine abweichende
            Laufzeit individuell vereinbart wurde.
          </p>
          ...
          <ul className="mb-4 list-disc space-y-1 pl-6">
            ...
            <li>
              Eröffnung eines Insolvenzverfahrens über das Vermögen der anderen
              Partei
            </li>
          </ul>
          ...
          <ul className="mb-4 list-disc space-y-2 pl-6">
            <li>
              ...
              Aufwandsentschädigung von max. 25 % des ursprünglich vereinbarten
              Honorars.
            </li>
            <li>
              <strong>(b) Kündigung durch uns ohne wichtigen Grund:</strong>{" "}
              Rückerstattung bereits gezahlter Vorschüsse für nicht erbrachte
              Leistungen.
            </li>
            <li>
              <strong>(c) Kündigung bei wichtigem Grund:</strong> Abrechnung nur
              der bis zur Kündigung erbrachten Leistungen.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            Änderungen und Ergänzungen dieser AGB sowie des Vertrages bedürfen
            der Textform (§ 126b BGB; E-Mail genügt).
          </p>
          ...
          <p className="mb-4">
            ...
            übrigen Bestimmungen unberührt. Anstelle der unwirksamen Bestimmung
            gelten die gesetzlichen Vorschriften (§ 306 Abs. 2 BGB).
          </p>

          <h3 className="mb-2 font-semibold">13.3 Anwendbares Recht</h3>
          <p className="mb-4">
            Es gilt ausschließlich das Recht der Bundesrepublik Deutschland
            unter Ausschluss des UN-Kaufrechts (CISG). Für Verbraucher bleiben
            zwingende Verbraucherschutzvorschriften des Wohnsitzstaates
