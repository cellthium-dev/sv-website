      ...
      <main className="container mx-auto max-w-4xl px-5 py-16">
        ...
        <section className="mb-10" id="verantwortlicher">
          ...
          <address className="mb-4 not-italic">
            ...
            <br />
            Sachverständiger für Photovoltaikanlagen, zertifiziert nach ISO/IEC
            17024
            <br />
        ...
        <section className="mb-10" id="geltungsbereich">
          ...
          <p className="mb-4">
            ...
            Datenverarbeitungen im Zusammenhang mit unserer Geschäftstätigkeit
        ...
        <section className="mb-10" id="rechtsgrundlagen">
          ...
          <ul className="space-y-3">
            <li>
              <strong>Art. 6 Abs. 1 lit. a DSGVO – Einwilligung:</strong> Soweit
              Sie uns eine ausdrückliche Einwilligung erteilt haben (z.B. für
              nicht-essentielle Cookies). Widerrufbar jederzeit für die Zukunft.
            </li>
            <li>
              <strong>Art. 6 Abs. 1 lit. b DSGVO – Vertragserfüllung:</strong>{" "}
              Soweit die Verarbeitung zur Durchführung eines Vertrags oder zur
              Bearbeitung vorvertraglicher Anfragen erforderlich ist.
            </li>
            <li>
              <strong>
            ...
            <li>
              ...
              Z.B. für IT-Sicherheit, ordnungsgemäße Sachverständigentätigkeit
              und Geltendmachung rechtlicher Ansprüche.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10" id="website">
          ...
          <p className="mb-4">
            ...
            Website-Besucher auf Servern innerhalb der Europäischen Union. Ein
            Auftragsverarbeitungsvertrag gemäß Art. 28 DSGVO wurde
            abgeschlossen. Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO.
          </p>

          <h3 className="mb-2 font-semibold">4.2 Server-Log-Dateien</h3>
          <p className="mb-2">
            Beim Aufruf unserer Website erhebt der Hosting-Anbieter automatisch
          ...
          <ul className="mb-3 list-disc space-y-1 pl-6">
            ...
            <li>HTTP-Statuscode, Browsertyp und -version, Betriebssystem</li>
            <li>Referrer-URL, übertragene Datenmenge</li>
          </ul>
          <p className="mb-4">
            Speicherdauer: Löschung nach spätestens 7 Tagen. Rechtsgrundlage:
            Art. 6 Abs. 1 lit. f DSGVO.
          </p>

          <h3 className="mb-2 font-semibold">4.3 SSL-/TLS-Verschlüsselung</h3>
          <p className="mb-4">
            ...
            „https://" und dem Schloss-Symbol in der Browserleiste.
          </p>
        </section>
        ...
        <section className="mb-10" id="cookies">
          ...
          <p className="mb-4">
            ...
            Cookie-Consent, Grundfunktionen der Website). Diese werden ohne Ihre
            Einwilligung gesetzt, da sie für die Bereitstellung des Dienstes
            zwingend erforderlich sind. Rechtsgrundlage: § 25 Abs. 2 Nr. 2 TTDSG
          ...
          <p className="mb-4">
            ...
            Einwilligung über unser Cookie-Consent-Banner ein. Rechtsgrundlage:
        ...
        <section className="mb-10" id="kontakt">
          ...
          <p className="mb-4">
            ...
            E-Mail-Adresse, ggf. Telefonnummer sowie den Inhalt Ihrer Nachricht.
          </p>
          ...
          <p className="mb-4">
            ...
            Monate nach Abschluss der Bearbeitung. Bei Vertragsschluss gelten
            die Aufbewahrungsfristen für Vertragsdaten (Abschnitt 7.6).
          </p>
        </section>
        ...
        <section className="mb-10" id="sachverstaendigen">
          ...
          <ul className="mb-4 space-y-2">
            <li>
              <strong>Stamm- und Kontaktdaten:</strong> Name, Firma, Anschrift,
              E-Mail, Telefonnummer
            </li>
            <li>
              <strong>Vertrags- und Abrechnungsdaten:</strong> Auftragsdetails,
            ...
            <li>
              <strong>Standort- und Gebäudedaten:</strong> Adresse, Grundrisse,
              Lagepläne
            </li>
            <li>
              <strong>Foto- und Videodokumentation:</strong> Aufnahmen von
              Anlagen; Personen werden unkenntlich gemacht (Datenminimierung)
            </li>
            <li>
          ...
          <p className="mb-4">
            Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung), Art. 6 Abs. 1 lit. c
            DSGVO (gesetzliche Aufbewahrungspflichten), Art. 6 Abs. 1 lit. f
            DSGVO (berechtigtes Interesse an ordnungsgemäßer
          ...
          <p className="mb-4">
            Der Auftraggeber ist verpflichtet, betroffene Dritte (z.B. Mieter,
            Nachbarn) vorab über den Sachverständigentermin zu informieren.
            Personen auf Aufnahmen werden nach dem Grundsatz der
            Datenminimierung unkenntlich gemacht.
          </p>
          ...
          <ul className="mb-4 list-disc space-y-1 pl-6">
            ...
            <li>Behörden, Gerichte (bei gesetzlicher Offenbarungspflicht)</li>
          ...
          <ul className="mb-4 list-disc space-y-1 pl-6">
            ...
            <li>
              Gutachtenakten: bis zu 10 Jahre ab Gutachtenerstellung (ISO/IEC
              17024)
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10" id="caleu">
          ...
          <p className="mb-4">
            Zur Terminvereinbarung nutzen wir Cal.eu (EU-gehostete Variante von
            Cal.com, betrieben von Cal.com, Inc., USA). Sämtliche
            Terminbuchungsdaten werden ausschließlich auf Servern innerhalb der
            Europäischen Union verarbeitet – keine Übermittlung in Drittländer.
        ...
        <section className="mb-10" id="drittdienste">
          ...
          <p className="mb-4">
            ...
            Ireland Limited, Irland). Beim Laden der Karte werden IP-Adresse,
            Browser- und Geräteinformationen an Google übertragen. Google ist
          ...
          <p className="mb-4">
            ...
            übertragen. Rechtsgrundlage: Art. 6 Abs. 1 lit. a oder lit. f DSGVO.
          </p>
        </section>
        ...
        <section className="mb-10" id="videokonferenzen">
          ...
          <p className="mb-4">
            ...
            Teams oder Google Meet. Aufzeichnungen erfolgen ausschließlich mit
            ausdrücklicher Einwilligung aller Teilnehmer und werden nach 30
            Tagen gelöscht. Mit allen Anbietern wurden
        ...
        <section className="mb-10" id="zahlung">
          ...
          <p className="mb-4">
            ...
            Banküberweisung. Speicherdauer: 10 Jahre gemäß § 147 Abs. 1 Nr. 1
            AO, § 257 Abs. 1 Nr. 1 HGB.
          </p>
        </section>
        ...
        <section className="mb-10" id="empfaenger">
          ...
          <ul className="space-y-3">
            <li>
              <strong>Hosting:</strong> Hostinger International Ltd. (Zypern,
              EU) – Datenverarbeitung innerhalb der EU.
            </li>
            <li>
              <strong>Online-Terminbuchung:</strong> Cal.com, Inc. (USA) über
              Cal.eu – ausschließlich EU-Server, keine Drittlandübermittlung.
            </li>
            <li>
            ...
            <li>
              <strong>Videokonferenz:</strong> Zoom, Microsoft, Google – EU-US
        ...
        <section className="mb-10" id="drittlaender">
          ...
          <p className="mb-4">
            Für Google-Dienste besteht ein Angemessenheitsbeschluss im Rahmen
            des EU-US Data Privacy Framework (Art. 45 DSGVO). Für sonstige
            Anbieter außerhalb des EWR stützen wir die Übermittlung auf
            EU-Standardvertragsklauseln (Art. 46 Abs. 2 lit. c DSGVO). Für
            Cal.eu findet keine Drittlandübermittlung statt.
          </p>
        </section>
        ...
        <section className="mb-10" id="speicherdauer">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <strong>Allgemeine Kontaktanfragen:</strong> Max. 6 Monate nach
              Bearbeitung
            </li>
            <li>
              <strong>Terminbuchungsdaten (Cal.eu):</strong> Max. 6 Monate nach
              Termin (ohne Vertragsschluss)
            </li>
            <li>
              <strong>Vertragsdaten und Rechnungen:</strong> 10 Jahre (§ 147 AO,
              § 257 HGB)
            </li>
            <li>
        ...
        <section className="mb-10" id="betroffenenrechte">
          ...
          <ul className="space-y-3">
            ...
            <li>
              ...
              Recht, aus Gründen Ihrer besonderen Situation jederzeit gegen die
              Verarbeitung auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO
              Widerspruch einzulegen. Widerspruch an:{" "}
              <a
                className="text-[#2563EB] hover:underline"
                href="mailto:info@sv-bauten.de"
              >
        ...
        <section className="mb-10" id="pflicht">
          ...
          <p className="mb-4">
            Im Rahmen der Vertragsanbahnung und -durchführung müssen Sie die für
            die Begründung, Durchführung und Beendigung des
        ...
        <section className="mb-10" id="profiling">
          ...
          <p className="mb-4">
            ...
            Sinne von Art. 22 DSGVO findet bei uns nicht statt. Alle
            Entscheidungen werden von dem Sachverständigen persönlich getroffen.
          </p>
        </section>
        ...
        <section className="mb-10" id="datensicherheit">
          ...
          <ul className="mb-4 list-disc space-y-1 pl-6">
            ...
            <li>
              Sichere physische Aufbewahrung von Dokumenten und Gutachtenakten
            </li>
            <li>
        ...
        <section className="mb-10" id="aktualitaet">
          ...
          <p>
            ...
            Datenverarbeitungsprozesse oder die Rechtslage ändern. Die aktuelle
            Fassung ist jederzeit unter sv-bauten.de/datenschutz abrufbar. Bei
            wesentlichen Änderungen informieren wir Sie gesondert.
          </p>
        </section>
      </main>
      <Footer />
